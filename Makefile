...
AVRDUDE_FLAGS = -p $(AVRDUDE_MCU) -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER) -u
...
# Default target.
all: begin gccversion sizebefore build sizeafter finished tidy end
...
# Program the device.  
program: $(TARGET).hex $(TARGET).eep tidy
